...
As of today, the [vaccines do a better job than natural immunity](https://directorsblog.nih.gov/2021/06/22/how-immunity-generated-from-covid-19-vaccines-differs-from-an-infection/) in protecting against the virus. That's because the antibodies they produce are heavily focused on the receptor binding domain of the spike protein, whereas the naturally produced antibodies are more generic and more often target other portions of the spike protein.
